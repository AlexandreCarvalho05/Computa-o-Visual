export const posts = [
  {
    id: 'expectativas-da-disciplina', number: 1,
    title: 'O que eu esperava da disciplina de Computação Visual?', date: '18/08/2026',
    description: 'Primeiras impressões sobre pixels, matrizes e o que espero aprender ao longo do semestre.', published: true,
    content: [
  ...
  {
    id: 'conhecendo-opengl', number: 2, title: 'Conhecendo um pouco sobre OpenGL', date: '18/08/2026',
    description: 'Um primeiro contato com a biblioteca gráfica, suas formas primitivas e o papel da GPU.', published: true,
    content: [
  ...
  ...[['01/09/2026', 3], ['15/09/2026', 4], ['29/09/2026', 5], ['13/10/2026', 6], ['27/10/2026', 7], ['10/11/2026', 8]].map(([date, number]) => ({
